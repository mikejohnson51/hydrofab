---
title: "Coastal Units with hydrofab"
...
This article demonstrates how to work with coastal catchments and small coastal basins in an hydrofab workflow.
...
```
Now that we have our subset ready to go, we'll need to get some flow direction and flow accumulation data to use with hydrofab later on.
...
if(!dir.exists(file.path(fdr_dir, "NHDPlusCA/"))) {
  hydrofab::download_fdr_fac(fdr_dir, regions = "18")
}
