...
test_that("collapse flowlines works as expected", {
  ...
  expect(flines_out$toCOMID[which(flines_out$COMID == 11687226)] ==
           11687358 &
  ...
  expect(flines_out$toCOMID[which(flines_out$COMID == 11687548)] ==
           11689978)

  expect(flines_out$joined_fromCOMID[which(flines_out$COMID == 11689928)] ==
           11687548 &
  ...
  expect(flines_out$joined_fromCOMID[which(flines_out$COMID == 11690260)] ==
           11690256)
  expect(flines_out$joined_fromCOMID[which(flines_out$COMID == 11690262)] ==
           11690256)
  expect(flines_out$joined_fromCOMID[which(flines_out$COMID == 11690568)] ==
           11690256)
  expect(flines_out$joined_fromCOMID[which(flines_out$COMID == 11690258)] ==
           11690256)
...
test_that("headwater / top of mainstem collapes works as expected", {
  ...
  expect(flines_out$joined_fromCOMID[which(flines_out$COMID == 1629565)] ==
           1629821)
  ...
  expect(flines_out$joined_toCOMID[which(flines_out$COMID == 10840906)] ==
           10840550)
  expect(flines_out$joined_toCOMID[which(flines_out$COMID == 10840550)] ==
           -9999)
  expect(flines_out$toCOMID[which(flines_out$COMID == 10840550)] ==
...
test_that("collapse flowlines works as expected with mainstem thresh", {
  ...
  expect(flines$joined_fromCOMID[which(flines$COMID == 11690124)] ==
           11688868)
})
...
test_that("repeat collapse doesn't leave orphans", {
  ...
  expect(flines$joined_fromCOMID[which(flines$COMID == 21974341)] ==
           21975097)
  ...
  # Old Tests:
  expect(flines$joined_toCOMID[which(flines$COMID == 21974341)] ==
           21975095)
  expect(flines$joined_toCOMID[which(flines$COMID == 21975097)] ==
           21975095)
  expect(flines$toCOMID[which(flines$COMID == 21975777)] ==
