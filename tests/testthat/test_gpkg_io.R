context("Test hydrofabric I/O methods")

test_that("IO methods", {
  
  gpkg = "data/io.gpkg"

  out =  read_hydrofabric(gpkg = gpkg, verbose = FALSE)
  ...
  out3 = read_hydrofabric(catchments = out$catchments, flowpaths = out$flowpaths, verbose = FALSE)
  
  out4 = read_hydrofabric(catchments = out$catchments, flowpaths = out$flowpaths, crs = 5070, verbose = FALSE)
  
  out5 = read_hydrofabric(catchments = NULL, flowpaths = out$flowpaths, crs = 5070, verbose = FALSE)
  out6 = read_hydrofabric(catchments = out$catchments, flowpaths = NULL, crs = 5070, verbose = FALSE)
